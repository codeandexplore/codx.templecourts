...
Shared UI component library for the Temple Courts frontend. Built on shadcn/ui (Radix UI primitives + Tailwind CSS) with design system tokens. Covers Button, Card, Input/Textarea, Badge, Tabs, and Dialog components.
