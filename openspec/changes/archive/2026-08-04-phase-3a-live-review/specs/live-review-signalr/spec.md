...
Real-time synchronization of StudySession state between Teacher and Student via SignalR. The Teacher owns the session; the Student observes. State broadcasts are scoped to the session group.
