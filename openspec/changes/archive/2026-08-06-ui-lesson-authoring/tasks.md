...
- [x] 8.4 Manually verify: select lesson → create draft → add node → add child node → add question → publish
- [x] 8.5 Manually verify: lesson selector shows all lessons, version list shows correct statuses, tree renders depth correctly
- [x] 8.6 Manually verify: sibling gating toggle persists, reorder works, delete with children shows confirmation
- [x] 8.7 Manually verify: Assignments tab shows all pairs, reassign creates new assignment and ends old one
