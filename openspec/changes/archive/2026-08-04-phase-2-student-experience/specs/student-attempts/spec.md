...
Student lesson runner: start an attempt against a published lesson version, submit and update answers, enforce sibling-gating rules — all without auto-grading or review logic (Phase 3).
