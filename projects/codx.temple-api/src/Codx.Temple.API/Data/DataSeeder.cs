...
public static class DataSeeder
{
    ...
    private static async Task SeedLessonsAsync(AppDbContext db)
    {
        ...
        await AddLesson(db, 2, "The Creation Account", (db, v1s) => {
        ...
        await AddLesson(db, 3, "The Fall and Promise", (db, v1s) => {
        ...
        await AddLesson(db, 4, "The Flood and Covenant", (db, v1s) => {
        ...
        await AddLesson(db, 5, "The Call of Abram", (db, v1s) => {
        ...
        await AddLesson(db, 6, "The Covenant with Abraham", (db, v1s) => {
        ...
        await AddLesson(db, 7, "Isaac and Ishmael", (db, v1s) => {
        ...
        await AddLesson(db, 8, "Jacob Becomes Israel", (db, v1s) => {
        ...
        await AddLesson(db, 9, "Joseph — God's Sovereignty", (db, v1s) => {
        ...
        await AddLesson(db, 10, "Moses and the Exodus", (db, v1s) => {
        ...
        await AddLesson(db, 11, "The Law and the Tabernacle", (db, v1s) => {
        ...
        await AddLesson(db, 12, "The Wilderness Journey", (db, v1s) => {
        ...
        await AddLesson(db, 13, "Entering the Promised Land", (db, v1s) => {
        ...
        await AddLesson(db, 14, "The Judges", (db, v1s) => {
        ...
        await AddLesson(db, 15, "David — A Man After God's Heart", (db, v1s) => {
        ...
        await AddLesson(db, 16, "Wisdom from Proverbs", (db, v1s) => {
    ...
    private static async Task AddLesson(AppDbContext db, int number, string title, Action<AppDbContext, LessonVersion> build)
    {
