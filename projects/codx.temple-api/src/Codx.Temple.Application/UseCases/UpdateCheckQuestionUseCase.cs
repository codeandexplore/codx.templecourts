...
public class UpdateCheckQuestionUseCase
{
    private readonly IAppDbContext _db;
    private readonly ICurrentUserAccessor _currentUser;

    public UpdateCheckQuestionUseCase(IAppDbContext db, ICurrentUserAccessor currentUser)
    {
        _db = db;
        _currentUser = currentUser;
    }

    public virtual async Task<TeacherCheckQuestionDto> ExecuteAsync(Guid id, UpdateCheckQuestionRequest request, CancellationToken ct = default)
    {
